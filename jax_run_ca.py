import argparse
from experiments.jax_exp_long_term_forecasting_ca import JAX_Exp_Long_Term_Forecast
import random
import numpy as np
import pdb
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoints', type=str, default='/home/vhluong/simplebaseline_efficiency/jax_version__/', help='location of model checkpoints')
    ...
    parser.add_argument('--alpha', type=float, default=1, help='weight of inner product score in the geometric attention')
    ...
    # optimization
    parser.add_argument('--num_workers', type=int, default=15, help='data loader num workers')
    ...
    args.rngs = nnx.Rngs(args.fix_seed)
    ...
    Exp = JAX_Exp_Long_Term_Forecast
